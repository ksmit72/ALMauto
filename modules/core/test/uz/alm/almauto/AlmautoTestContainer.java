...
public class AlmautoTestContainer extends TestContainer {

    public AlmautoTestContainer() {
        super();
    ...
    public static class Common extends AlmautoTestContainer {

        public static final AlmautoTestContainer.Common INSTANCE = new AlmautoTestContainer.Common();
